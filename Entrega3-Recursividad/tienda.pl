...
% ENTREGA 3
% El caso base imprimir(1) imprime un número aleatorio, 
% luego el texto "fin", y corta la recursión. Es la condición 
% que detiene el proceso para que no siga llamando a imprimir/1 indefinidamente. 
